...
if (isset($_SESSION["name"])) {
 echo "$data .='</tbody></table>
              ...
              <a href='checkout_counter.php'><button class='btn btn-success btn-lg'><span class='glyphicon glyphicon-ok-sign'></span> Check Out</button></h3>
              <hr>'";
  // echo $data;
} else {
  echo "$data .='</tbody></table>
              <hr>
              <h3 align='right'>Total: &#x20B1; <span id='grandTotal'>$grand_total </span><br>
              <a href='registerloginform.php'><button class='btn btn-success btn-lg'><span class='glyphicon glyphicon-ok-sign'></span> Check Out</button></h3>
              <hr>'";
